...
std::string cmd = construct_sdecc_candidate_messages_cmd(MMU.candidates_sdecc_script_filename, victim_message, MMU.memwordsize, MMU.ncodewordbits, MMU.code_type);

...
void parse_sdecc_recovery_output(std::string script_stdout, uint8_t* recovered_word, const uint8_t* correct_word, const uint8_t* candidate_correct_messages, uint32_t memwordsize);
